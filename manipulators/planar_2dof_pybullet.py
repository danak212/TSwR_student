...
class PlanarManipulator2DOFPyBullet:
    def __init__(self, timestep, q0, qdot0, multimodel=False):
        ...
        self.client.loadURDF("./urdf/planar2dof.urdf", flags=pybullet.URDF_USE_IMPLICIT_CYLINDER
        ...
        for i in range(3):
            self.client.changeDynamics(0, i, lateralFriction=0.0, linearDamping=0.0, angularDamping=0.0)
